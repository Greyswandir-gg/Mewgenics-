...
const StatDisplay: React.FC<StatDisplayProps> = ({ def, current, gene, delta, size = 'md' }) => {
  ...
  return (
    <div className={`flex flex-col gap-1 py-3 border-b-2 border-black/10 ${size === 'sm' ? 'text-[11px]' : 'text-base'} font-black uppercase tracking-tight`}>
      ...
      <div className="flex items-center gap-4 mono">
        <div className="bg-white border-2 border-black px-3 py-1 sketch-border-sm flex items-center justify-center min-w-[70px]">
